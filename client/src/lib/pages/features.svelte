<main class="bg-white lg:py-20 md:px-10  py-10 px-5">
<div class="flex flex-col lg:gap-5 gap-2 lg:w-1/2">
    <p class="text-[#178490] font-sans font-medium text-base">
     Additional Features   
    </p>
    <h1 class="text-[#252525] lg:block hidden leading-normal font-semibold text-5xl ">
        Unlock Powerful Features <br />for Your Hospital
    </h1>
    <h1 class="text-[#252525] lg:hidden block leading-normal font-semibold  text-3xl">
        Unlock Powerful Features for Your Hospital
    </h1>
    <p class="text-[#3E3E3E] block lg:hidden text-lg">
        Boost operations and patient care with advanced tools.
    </p>
</div>
<div class="grid lg:grid-cols-3 grid-cols-2   lg:gap-20 md:gap-20 gap-3 relative lg:-top-7  top-5">
    <div class="hidden lg:block">
        <div class="h-10 w-10  "> </div>
        <p class="text-[#3E3E3E] text-2xl">
...
<div class="grid lg:w-[97%] lg:grid-cols-3 grid-cols-2 lg:gap-16 md:gap-10 gap-3 md:mt-14 lg:mt-10 mt-10  ">
    <div class="flex flex-col lg:gap-4 gap-2 ">
