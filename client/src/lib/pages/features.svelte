<main class="bg-white lg:py-20 md:px-10  md:py-14 py-10 px-5">
...
<div class="grid lg:grid-cols-3 grid-cols-2 lg:gap-20 md:gap-20 gap-3 relative lg:-top-7 md:top-14 top-8">
